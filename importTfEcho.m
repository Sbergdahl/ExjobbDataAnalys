function [x,y,th,time] = importTfEcho(path,filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [THROWNMAP,PASSED,TO,ARGUMENT] = IMPORTFILE(FILENAME) Reads data from
%   text file FILENAME for the default selection.
%
%   [THROWNMAP,PASSED,TO,ARGUMENT] = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [thrownmap,passed,to,argument] = importfile('map_base.csv',1, 592);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/12/14 16:36:07
...
%% Sort the data
outdata=[];
data = cell2mat(rawNumericColumns);

for iter=1:length(data)-1
   if (~isnan(data(iter,1))) && (data(iter,1) < 100000)
       outdata = [outdata; data(iter-1,1) data(iter,1) data(iter,2) data(iter+2,3)];
   end
end
